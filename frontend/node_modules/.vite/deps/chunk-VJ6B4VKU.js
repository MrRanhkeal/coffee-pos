...
var fullClone = _objectSpread2({}, React3);
...
var fullClone2 = _objectSpread2({}, React4);
...
var style_default = genStyleHooks("Skeleton", (token2) => {
  const {
    componentCls,
    calc
  } = token2;
...
var SkeletonAvatar = (props) => {
  ...
  return wrapCSSVar(React34.createElement("div", {
    className: cls
  }, React34.createElement(Element_default, Object.assign({
...
var SkeletonButton = (props) => {
  ...
  return wrapCSSVar(React35.createElement("div", {
    className: cls
  }, React35.createElement(Element_default, Object.assign({
...
var SkeletonImage = (props) => {
  ...
  }, React36.createElement("title", null, "Image placeholder"), React36.createElement("path", {
    d: path,
...
var SkeletonInput = (props) => {
  ...
  return wrapCSSVar(React37.createElement("div", {
    className: cls
  }, React37.createElement(Element_default, Object.assign({
...
var SkeletonNode = (props) => {
  ...
  const content = children !== null && children !== void 0 ? children : React38.createElement(DotChartOutlined_default, null);
  return wrapCSSVar(React38.createElement("div", {
    className: cls
...
var Skeleton = (props) => {
  ...
  if (loading || !("loading" in props)) {
    ...
    if (hasAvatar) {
      ...
      }, React41.createElement(Element_default, Object.assign({}, avatarProps)));
    }
    let contentNode;
    if (hasTitle || hasParagraph) {
      let $title;
      if (hasTitle) {
        ...
        $title = React41.createElement(Title_default, Object.assign({}, titleProps));
      }
      let paragraphNode;
      if (hasParagraph) {
        ...
        paragraphNode = React41.createElement(Paragraph_default, Object.assign({}, paragraphProps));
      }
    ...
    return wrapCSSVar(React41.createElement("div", {
      className: cls,
...
var StatisticNumber = (props) => {
  ...
  if (typeof formatter === "function") {
    ...
    if (!cells || val === "-") {
      ...
      valueNode = [React42.createElement("span", {
        key: "int",
        className: `${prefixCls}-content-value-int`
      }, negative, int), decimal && React42.createElement("span", {
        key: "decimal",
...
var style_default2 = genStyleHooks("Statistic", (token2) => {
...
var Statistic = (props) => {
  const {
    ...
    onMouseEnter,
    onMouseLeave
  } = props, rest = __rest4(props, ["prefixCls", "className", "rootClassName", "style", "valueStyle", "value", "title", "valueRender", "prefix", "suffix", "loading", "formatter", "precision", "decimalSeparator", "groupSeparator", "onMouseEnter", "onMouseLeave"]);
  const {
    getPrefixCls,
    direction,
    statistic: statistic2
  ...
  const valueNode = React43.createElement(Number_default, {
    decimalSeparator,
    groupSeparator,
    prefixCls,
    formatter,
  ...
  const cls = (0, import_classnames11.default)(prefixCls, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  ...
  return wrapCSSVar(React43.createElement("div", Object.assign({}, restProps, {
    className: cls,
    style: Object.assign(Object.assign({}, statistic2 === null || statistic2 === void 0 ? void 0 : statistic2.style), style2),
    onMouseEnter,
    onMouseLeave
  }), title && React43.createElement("div", {
    className: `${prefixCls}-title`
  }, title), React43.createElement(skeleton_default, {
    paragraph: false,
    loading,
    ...
    style: valueStyle,
    className: `${prefixCls}-content`
  }, prefix2 && React43.createElement("span", {
    className: `${prefixCls}-content-prefix`
  }, prefix2), valueRender ? valueRender(valueNode) : valueNode, suffix && React43.createElement("span", {
...
//# sourceMappingURL=chunk-VJ6B4VKU.js.map
