...
var useMobile = function useMobile2() {
  var _useState = (0, import_react2.useState)(false), _useState2 = _slicedToArray(_useState, 2), mobile = _useState2[0], setMobile = _useState2[1];
...
function StepHandler(_ref) {
  ...
  }, React.createElement("span", _extends({}, sharedHandlerProps, {
  ...
  }), upNode || React.createElement("span", {
    unselectable: "on",
  ...
  }), downNode || React.createElement("span", {
    unselectable: "on",
...
var useFrame_default = function() {
  var idRef = (0, import_react3.useRef)(0);
...
var _excluded2 = ["disabled", "style", "prefixCls", "value", "prefix", "suffix", "addonBefore", "addonAfter", "className", "classNames"];
...
var InternalInputNumber = React2.forwardRef(function(props, ref) {
  ...
  var _React$useState3 = React2.useState(function() {
    return es_default(value !== null && value !== void 0 ? value : defaultValue);
  ...
  var getPrecision = React2.useCallback(function(numStr, userTyping) {
    if (userTyping) {
      return void 0;
    }
    if (precision >= 0) {
  ...
  var mergedParser = React2.useCallback(function(num) {
  ...
  var mergedFormatter = React2.useCallback(function(number, userTyping) {
    if (formatter) {
  ...
  var maxDecimal = React2.useMemo(function() {
    return getDecimalIfValidate(max);
  }, [max, precision]);
  var minDecimal = React2.useMemo(function() {
    return getDecimalIfValidate(min);
  }, [min, precision]);
  var upDisabled = React2.useMemo(function() {
    if (!maxDecimal || !decimalValue || decimalValue.isInvalidate()) {
      return false;
    }
    return maxDecimal.lessEquals(decimalValue);
  }, [maxDecimal, decimalValue]);
  var downDisabled = React2.useMemo(function() {
  ...
  var triggerValueUpdate = function triggerValueUpdate2(newValue, userTyping) {
    ...
    if (!readOnly && !disabled && isRangeValidate) {
      ...
      if (mergedPrecision >= 0) {
        updateValue = es_default(toFixed(numStr, ".", mergedPrecision));
        if (!isInRange(updateValue)) {
          updateValue = es_default(toFixed(numStr, ".", mergedPrecision, true));
        }
      }
  ...
  var collectInputValue = function collectInputValue2(inputStr) {
    ...
    if (!compositionRef.current) {
      ...
      var finalDecimal = es_default(finalValue);
  ...
  var onInternalStep = function onInternalStep2(up) {
    ...
    var stepDecimal = es_default(shiftKeyRef.current ? getDecupleSteps(step) : step);
    if (!up) {
      stepDecimal = stepDecimal.negate();
    }
    var target = (decimalValue || es_default(0)).add(stepDecimal.toString());
  ...
  var flushInputValue = function flushInputValue2(userTyping) {
    var parsedValue = es_default(mergedParser(inputValue));
    var formatValue;
  ...
  useLayoutUpdateEffect(function() {
    var newValue = es_default(value);
    setDecimalValue(newValue);
    var currentParsedValue = es_default(mergedParser(inputValue));
  ...
  return React2.createElement("div", {
    ref: domRef,
    className: (0, import_classnames2.default)(prefixCls, className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-focused"), focus), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-readonly"), readOnly), "".concat(prefixCls, "-not-a-number"), decimalValue.isNaN()), "".concat(prefixCls, "-out-of-range"), !decimalValue.isInvalidate() && !isInRange(decimalValue))),
    style,
    ...
    onCompositionEnd,
    onBeforeInput
  }, controls && React2.createElement(StepHandler, {
    prefixCls,
    upNode: upHandler,
  ...
  }, React2.createElement("input", _extends({
    autoComplete: "off",
    role: "spinbutton",
    "aria-valuemin": min,
    "aria-valuemax": max,
...
var InputNumber = React2.forwardRef(function(props, ref) {
  var disabled = props.disabled, style = props.style, _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-input-number" : _props$prefixCls, value = props.value, prefix = props.prefix, suffix = props.suffix, addonBefore = props.addonBefore, addonAfter = props.addonAfter, className = props.className, classNames3 = props.classNames, rest = _objectWithoutProperties(props, _excluded2);
  var holderRef = React2.useRef(null);
  var inputNumberDomRef = React2.useRef(null);
  var inputFocusRef = React2.useRef(null);
  ...
  return React2.createElement(BaseInput_default, {
    className,
    triggerFocus: focus,
    prefixCls,
    value,
    ...
    ref: holderRef
  }, React2.createElement(InternalInputNumber, _extends({
    prefixCls,
    disabled,
    ref: inputFocusRef,
    domRef: inputNumberDomRef,
    className: classNames3 === null || classNames3 === void 0 ? void 0 : classNames3.input
  }, rest)));
});
if (true) {
...
var es_default2 = InputNumber_default;
...
var InputNumber2 = React3.forwardRef((props, ref) => {
  if (true) {
  ...
  let upIcon = React3.createElement(UpOutlined_default, {
    className: `${prefixCls}-handler-up-inner`
  });
  let downIcon = React3.createElement(DownOutlined_default, {
    className: `${prefixCls}-handler-down-inner`
  });
  const controlsTemp = typeof controls === "boolean" ? controls : void 0;
  if (typeof controls === "object") {
    upIcon = typeof controls.upIcon === "undefined" ? upIcon : React3.createElement("span", {
      className: `${prefixCls}-handler-up-inner`
    }, controls.upIcon);
    downIcon = typeof controls.downIcon === "undefined" ? downIcon : React3.createElement("span", {
      className: `${prefixCls}-handler-down-inner`
    }, controls.downIcon);
  }
  const {
  ...
  const suffixNode = hasFeedback && React3.createElement(React3.Fragment, null, feedbackIcon);
  const inputNumberClass = (0, import_classnames3.default)({
  ...
  const element = React3.createElement(es_default2, Object.assign({
    ref: inputRef,
    disabled: mergedDisabled,
    className: (0, import_classnames3.default)(cssVarCls, rootCls, className, rootClassName, compactItemClassnames),
    upHandler: upIcon,
    ...
    addonBefore: addonBefore && React3.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonBefore),
    addonAfter: addonAfter && React3.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonAfter),
    classNames: {
...
var PureInputNumber = (props) => React3.createElement(config_provider_default, {
  theme: {
    components: {
      InputNumber: {
        handleVisible: true
...
}, React3.createElement(InputNumber2, Object.assign({}, props)));
if (true) {
...
//# sourceMappingURL=chunk-B77ZGMGM.js.map
