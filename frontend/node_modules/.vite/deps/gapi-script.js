...
(function() {
  ...
  var ra = function(a2, b2) {
    a2 = a2.split("%s");
    for (var c = "", d = a2.length - 1, e = 0; e < d; e++) c += a2[e] + (e < b2.length ? b2[e] : "%s");
    q.call(this, c + a2[d]);
  };
  oa(ra, q);
  ...
  var Ba = function(a2) {
    if (a2 instanceof t && a2.constructor === t && a2.ca === Aa) return a2.P;
  ...
  var Ha = function(a2) {
    if (a2 instanceof w && a2.constructor === w) return a2.M;
  ...
  var x = window, z = document, La = x.location, Ma = function() {
    ...
    for (var b2 = 0; b2 < this.length; b2++) if (this[b2] === a2) return b2;
    return -1;
  }, Pa = function(a2) {
    a2 = a2.sort();
    ...
    var a2;
    if ((a2 = Object.create) && Na.test(a2)) a2 = a2(null);
    else {
      a2 = {};
      for (var b2 in a2) a2[b2] = void 0;
    }
    return a2;
  }, C = function(a2, b2) {
    return Object.prototype.hasOwnProperty.call(a2, b2);
  }, Xa = function(a2) {
    if (Na.test(Object.keys)) return Object.keys(a2);
    var b2 = [], c;
    for (c in a2) C(a2, c) && b2.push(c);
    return b2;
  }, D = function(a2, b2) {
    a2 = a2 || {};
    for (var c in a2) C(a2, c) && (b2[c] = a2[c]);
  }, Ya = function(a2) {
    return function() {
      x.setTimeout(a2, 0);
    };
  }, E = function(a2, b2) {
    if (!a2) throw Error(b2 || "");
  }, F = A(x, "gapi", {});
  var H = function(a2, b2, c) {
    var d = new RegExp("([#].*&|[#])" + b2 + "=([^&#]*)", "g");
    b2 = new RegExp("([?#].*&|[?#])" + b2 + "=([^&#]*)", "g");
    if (a2 = a2 && (d.exec(a2) || b2.exec(a2))) try {
    ...
    var c = [];
    if (a2) {
      for (var d in a2) if (C(a2, d) && null != a2[d]) {
  ...
  var jb = function(a2, b2, c, d) {
    if (x[c + "EventListener"]) x[c + "EventListener"](a2, b2, false);
    else if (x[d + "tachEvent"]) x[d + "tachEvent"]("on" + a2, b2);
  }, kb = function() {
    var a2 = z.readyState;
    ...
    if (kb()) a2();
      ...
      var b2 = false, c = function() {
        if (!b2) return b2 = true, a2.apply(this, arguments);
      };
  ...
  N.push(["jsl", function(a2) {
    for (var b2 in a2) if (C(a2, b2)) {
      var c = a2[b2];
      "object" == typeof c ? K[b2] = A(K, b2, []).concat(c) : A(K, b2, c);
    }
    if (b2 = a2.u) a2 = A(K, "us", []), a2.push(b2), (b2 = /^https:(.*)$/.exec(b2)) && a2.push("http:" + b2[1]);
  }]);
  var Cb = /^(\/[a-zA-Z0-9_\-]+)+$/, Db = [/\/amp\//, /\/amp$/, /^\/amp$/], Eb = /^[a-zA-Z0-9\-_\.,!]+$/, Fb = /^gapi\.loaded_[0-9]+$/, Gb = /^[a-zA-Z0-9,._-]+$/, Kb = function(a2, b2, c, d) {
    ...
    for (var b2 = a2.substring(1).split("/"), c = []; b2.length; ) {
      a2 = b2.shift();
      if (!a2.length || 0 == a2.indexOf(".")) O("empty/relative directory");
    ...
    c = 0;
    for (d = Db.length; c < d; ++c) Db[c].test(b2) && O("invalid_prefix");
    c = Ob(a2, "k", true);
    d = Ob(a2, "am");
    e = Ob(a2, "rs");
    a2 = Ob(a2, "t");
  ...
  var bc = function(a2) {
    ...
    if (b2 && "object" === typeof b2) for (var d in b2) !Object.prototype.hasOwnProperty.call(b2, d) || c && "___goc" === d && "undefined" === typeof b2[d] || (a2[d] && b2[d] && "object" === typeof a2[d] && "object" === typeof b2[d] && !dc(a2[d]) && !dc(b2[d]) ? P(a2[d], b2[d]) : b2[d] && "object" === typeof b2[d] ? (a2[d] = dc(b2[d]) ? [] : {}, P(a2[d], b2[d])) : a2[d] = b2[d]);
  }, ec = function(a2) {
    if (a2 && !/^\s+$/.test(a2)) {
      for (; 0 == a2.charCodeAt(a2.length - 1); ) a2 = a2.substring(0, a2.length - 1);
      try {
    ...
    for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", true), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = ec(f)) && b2.push(f));
    a2 && fc(c, a2);
    d = bc("cd");
    a2 = 0;
    for (b2 = d.length; a2 < b2; ++a2) P(cc(), d[a2], true);
    d = bc("ci");
    a2 = 0;
    for (b2 = d.length; a2 < b2; ++a2) P(cc(), d[a2], true);
    a2 = 0;
    for (b2 = c.length; a2 < b2; ++a2) P(cc(), c[a2], true);
  }, Q = function(a2) {
    var b2 = cc();
    if (!a2) return b2;
    a2 = a2.split("/");
    for (var c = 0, d = a2.length; b2 && "object" === typeof b2 && c < d; ++c) b2 = b2[a2[c]];
  ...
  var jc = { callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 }, kc = false, lc = B(), mc = function() {
    if (!kc) {
      ...
      if (window.self !== window.top) {
        ...
        for (var e in jc) 0 < jc[e] && (b2 = H(a2, e, "")) && (lc[e] = b2);
      }
      kc = true;
    }
    e = B();
  ...
  var zc, S, T = void 0, U = function(a2) {
    ...
    if (b2) {
      for (var c = 0, d = b2.length; c < d; ++c) if (a2 === b2[c]) throw new TypeError("Converting circular structure to JSON");
    }
    d = typeof a2;
    if ("undefined" !== d) {
      ...
      if (null != a2 && "function" === typeof a2.toJSON && (Object.prototype.hasOwnProperty.call(
        a2,
        "toJSON"
      ) || (e !== Fc || a2.constructor !== Array && a2.constructor !== Object) && (e !== Ec || a2.constructor !== Array && a2.constructor !== Object) && e !== Dc && e !== Ac && e !== Cc && e !== Bc)) return W(a2.toJSON.call(a2), c);
      if (null == a2) b2[b2.length] = "null";
      else if (e === Ac) a2 = Number(a2), isNaN(a2) || isNaN(a2 - a2) ? a2 = "null" : -0 === a2 && 0 > 1 / a2 && (a2 = "-0"), b2[b2.length] = String(a2);
      else if (e === Cc) b2[b2.length] = String(!!Number(a2));
      else {
        if (e === Bc) return W(a2.toISOString.call(a2), c);
        if (e === Fc && V(a2.length) === Ac) {
          b2[b2.length] = "[";
          var f = 0;
          for (d = Number(a2.length) >> 0; f < d; ++f) f && (b2[b2.length] = ","), b2[b2.length] = W(a2[f], c) || "null";
          b2[b2.length] = "]";
        } else if (e == Dc && V(a2.length) === Ac) {
          b2[b2.length] = '"';
          f = 0;
          for (c = Number(a2.length) >> 0; f < c; ++f) d = String.prototype.charAt.call(a2, f), e = String.prototype.charCodeAt.call(a2, f), b2[b2.length] = "\b" === d ? "\\b" : "\f" === d ? "\\f" : "\n" === d ? "\\n" : "\r" === d ? "\\r" : "	" === d ? "\\t" : "\\" === d || '"' === d ? "\\" + d : 31 >= e ? "\\u" + (e + 65536).toString(16).substr(1) : 32 <= e && 65535 >= e ? d : "�";
          b2[b2.length] = '"';
        } else if ("object" === d) {
          b2[b2.length] = "{";
          d = 0;
          for (f in a2) Object.prototype.hasOwnProperty.call(
            a2,
            f
    ...
    a = String(a);
    if (Gc.test(a) || Hc.test(a) || Ic.test(a) || Jc.test(a)) return false;
    var b = a.replace(Kc, '""');
    b = b.replace(Lc, "0");
    b = b.replace(Mc, "");
    if (Nc.test(b)) return false;
    b = b.replace(Oc, "0");
    b = b.replace(Pc, "0");
    if (Qc.test(b) || Rc.test(b) || Sc.test(b) || Tc.test(b) || !b || (b = b.replace(Uc, ""))) return false;
    ...
    if (-1 !== S) return Yc(), T ? m.JSON.stringify.call(m.JSON, a2) : W(a2);
  ...
  var dd = function() {
    ...
    this.C = [];
    this.C[0] = 128;
    for (var a2 = 1; a2 < this.j; ++a2) this.C[a2] = 0;
    this.D = this.o = 0;
    this.reset();
  };
  oa(dd, cd);
  ...
  var ed = function(a2, b2, c) {
    c || (c = 0);
    var d = a2.da;
    if ("string" === typeof b2) for (var e = 0; 16 > e; e++) d[e] = b2.charCodeAt(c) << 24 | b2.charCodeAt(c + 1) << 16 | b2.charCodeAt(c + 2) << 8 | b2.charCodeAt(c + 3), c += 4;
    else for (e = 0; 16 > e; e++) d[e] = b2[c] << 24 | b2[c + 1] << 16 | b2[c + 2] << 8 | b2[c + 3], c += 4;
    for (e = 16; 80 > e; e++) {
  ...
  dd.prototype.update = function(a2, b2) {
    if (null != a2) {
      ...
      for (var c = b2 - this.j, d = 0, e = this.G, f = this.o; d < b2; ) {
        if (0 == f) for (; d <= c; ) ed(this, a2, d), d += this.j;
        if ("string" === typeof a2) for (; d < b2; ) {
        ...
        else for (; d < b2; ) if (e[f] = a2[d], ++f, ++d, f == this.j) {
          ed(this, e);
          f = 0;
          break;
        }
  ...
  dd.prototype.digest = function() {
    ...
    for (var c = this.j - 1; 56 <= c; c--) this.G[c] = b2 & 255, b2 /= 256;
    ed(this, this.G);
    for (c = b2 = 0; 5 > c; c++) for (var d = 24; 0 <= d; d -= 8) a2[b2] = this.b[c] >> d & 255, ++b2;
    return a2;
  };
  var fd = function() {
    this.O = new dd();
  ...
  var gd = x.crypto, hd = false, id = 0, jd = 0, kd = 1, ld = 0, md = "", nd = function(a2) {
    ...
    for (var c = [], d = 0, e = a2.length; d < e; ++d) c.push(a2.charCodeAt(d));
    b2.O.update(c);
    b2 = b2.O.digest();
    a2 = "";
    for (c = 0; c < b2.length; c++) a2 += "0123456789ABCDEF".charAt(Math.floor(b2[c] / 16)) + "0123456789ABCDEF".charAt(b2[c] % 16);
    return a2;
  };
  ...
  var vd = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" }, wd = { allowtransparency: true, onload: true }, xd = 0, yd = function(a2) {
    ...
    for (var k in c) a2 = c[k], "style" === k && "object" === typeof a2 ? D(a2, f.style) : wd[k] || f.setAttribute(k, String(a2));
  ...
  var Fd = function(a2) {
    ...
    for (var b2 = document.getElementsByTagName("link"), c = 0, d = b2.length; c < d; c++) {
      ...
      if (f && f.toLowerCase() == a2 && (e = e.getAttribute("href")) && (e = Fd(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) return e;
    }
  ...
  var Hd = { se: "0" }, Id = { post: true }, Jd = { style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none" }, Kd = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), Ld = A(K, "WI", B()), Md = function(a2, b2, c) {
    ...
    for (var g in Hd) e[g] = g + "/" + (b2[g] || Hd[g]) + "/";
    e = hb(z, d.replace(
      Bd,
      Ed(e)
    ));
    ...
    for (var p in b2) C(b2, p) && /^on/.test(p) && ("plus" != a2 || "onconnect" != p) && (n.push(p), delete f[p]);
    delete f.callback;
    c._methods = n.join(",");
    return fb(e, f, c);
  ...
  var Zd = function(a2, b2) {
    ...
    if (b2) for (var r in c) for (b2 = c[r], d = 0; d < b2.length; d++) b2[d].setAttribute("data-onload", true);
    ...
    if ($d(Vd || {})) for (var y in c) {
      a2 = c[y];
      u = 0;
      for (b2 = a2.length; u < b2; u++) a2[u].removeAttribute("data-gapiscan");
      ae(y);
    }
    else {
      d = [];
      for (y in c) for (a2 = c[y], u = 0, b2 = a2.length; u < b2; u++) e = a2[u], be(y, e, Pd(e), d, b2);
      ce(r, d);
    }
  }, de = function(a2) {
    var b2 = A(F, a2, {});
  ...
  var ae = function(a2, b2) {
    ...
    switch (he(b2, a2, f)) {
      ...
      case 1:
        if (b2.parentNode) {
          ...
          g.type = a2;
          if (c.rd) var k = b2;
          else k = document.createElement("div"), b2.setAttribute("data-gapistub", true), k.style.cssText = "position:absolute;width:450px;left:-10000px;", b2.parentNode.insertBefore(k, b2);
          g.siteElement = k;
          ...
          if (k.forcePost || p && 2e3 < f.length) {
            ...
            for (e = 0; e < h.length; e++) l = b2.createElement("input"), l.type = "hidden", l.name = h[e][0], l.value = h[e][1], k.appendChild(l);
            c.appendChild(k);
            k.submit();
            k.parentNode.removeChild(k);
            u && u.close();
            u = f;
          } else u = zd(b2, c, l, e, h);
          g.iframeNode = u;
    ...
    if (a2 && 1 === a2.nodeType && b2) {
      if (c) return 1;
      if (X[b2]) {
        if (pb[a2.nodeName.toLowerCase()]) return (a2 = a2.innerHTML) && a2.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1;
      } else {
        if (Td[b2]) return 0;
        if (Sd[b2]) return 1;
      }
    ...
    if (d) {
      a2 = {};
      for (var e in b2) C(b2, e) && (a2[e.toLowerCase()] = b2[e]);
      a2.rd = 1;
      (b2 = !!a2.ri) && delete a2.ri;
      e = [];
      be(c, d, a2, e, 0, b2, void 0);
      ce(c, e);
    } else pc("string" === "gapi." + c + ".render: missing element " + typeof a2 ? a2 : "");
  };
  A(F, "platform", {}).go = Zd;
  $d = function(a2) {
    for (var b2 = ["_c", "jsl", "h"], c = 0; c < b2.length && a2; c++) a2 = a2[b2[c]];
    b2 = qb(La.href);
  ...
  var lb = function(a2) {
    ...
    b2 = b2 || [];
    for (var c = 0; c < b2.length; ++c) a2(b2[c]);
    for (a2 = 0; a2 < b2.length; a2++) de(b2[a2]);
  };
  ...
  var le = /^\{h:'/, me = /^!_/, ne = "", ie = function(a2, b2) {
    ...
    function d(f) {
      ...
      if (oe(g, b2)) {
        ...
        pe(a2, function() {
          k && L("rqd");
          c();
          for (var l = A(K, "RPMQ", []), n = 0; n < l.length; n++) l[n]({ data: g, origin: h });
        });
      }
    }
    if (0 !== b2.length) {
    ...
    a2 = String(a2);
    if (le.test(a2)) return true;
    var c = false;
    me.test(a2) && (c = true, a2 = a2.substr(2));
    if (!/^\{/.test(a2)) return false;
    var d = Zc(a2);
    if (!d) return false;
    a2 = d.f;
  ...
  qe.prototype.read = function() {
    for (var a2 = this.L + "=", b2 = document.cookie.split(/;\s*/), c = 0; c < b2.length; ++c) {
      var d = b2[c];
      if (0 == d.indexOf(a2)) return d.substr(a2.length);
    }
  };
  qe.prototype.write = function(a2, b2) {
    if (!re.test(this.L)) throw "Invalid cookie name";
    if (!se.test(a2)) throw "Invalid cookie value";
    a2 = this.L + "=" + a2;
  ...
  te.iterate = function(a2) {
    for (var b2 in Y) Y.hasOwnProperty(b2) && a2(b2, Y[b2]);
  };
  ...
  var ye = function(a2) {
    if (0 !== a2.indexOf("GCSC")) return null;
    var b2 = { W: false };
    a2 = a2.substr(4);
    if (!a2) return b2;
    var c = a2.charAt(0);
    ...
    if (null !== a2) {
      ...
      if (c) {
        ...
        d = d && d.clientId;
        if (e) return { F: a2, ha: e, clientId: d };
      }
    }
    return null;
  };
