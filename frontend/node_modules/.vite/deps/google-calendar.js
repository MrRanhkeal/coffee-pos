...
var require_qs = __commonJS({
  "node_modules/qs/index.js"(exports) {
    ...
    function parseString(str) {
      var ret = reduce(String(str).split("&"), function(ret2, pair) {
        ...
        if ("" == key) key = pair, val = "";
        if ("" == key) return ret2;
        return merge(ret2, decode(key), decode(val));
...
var require_multipart = __commonJS({
  "node_modules/needle/lib/multipart.js"(exports) {
    ...
    exports.build = function(data, boundary, callback2) {
      if (typeof data != "object")
        return callback2(new Error("Multipart expects data as key/val object."));
      var body = "", object = flatten(data), count = Object.keys(object).length;
      if (count == 0)
        return callback2(new Error("Empty multipart body. Invalid data."));
      var done = function(err, section) {
        if (err) return callback2(err);
        if (section) body += section;
        --count || callback2(null, body + "--" + boundary + "--");
      };
    ...
    var generate_part = function(name, part, boundary, callback2) {
      var return_part = "--" + boundary + "\r\n";
      return_part += 'Content-Disposition: form-data; name="' + name + '"';
      var append = function(data, filename2) {
        if (data) {
      ...
      if ((part.file || part.buffer) && part.content_type) {
        ...
        if (typeof part.value == "object")
          return callback2(new Error("Object received for " + name + ", expected string."));
...
var require_auth = __commonJS({
  "node_modules/needle/lib/auth.js"(exports, module) {
    var createHash = require_crypto().createHash;
    ...
    digest.parse_header = function(header) {
      var challenge = {}, matches = header.match(/([a-z0-9_-]+)="([^"]+)"/gi);
      for (var i = 0, l = matches.length; i < l; i++) {
        var pos = matches[i].indexOf("="), key = matches[i].substring(0, pos), val = matches[i].substring(pos + 1);
    ...
    digest.generate = function(header, user, pass, method, path) {
      ...
      var ha1 = md5(user + ":" + challenge.realm + ":" + pass), ha2 = md5(method + ":" + path), resp = [ha1, challenge.nonce];
...
var require_needle = __commonJS({
  "node_modules/needle/lib/needle.js"(exports) {
    var fs = require_fs();
    var http = require_http();
    var https = require_https();
    var url = require_url();
    var Readable = require_stream().Readable;
    var stringify = require_qs().stringify;
    ...
    var parsers = {
      "application/json": function(data, callback2) {
        try {
          callback2(null, data && JSON.parse(data));
        } catch (e) {
          callback2(e, data);
        }
      }
    ...
    var Needle = {
      request: function(method, uri, data, options, callback2) {
        var self = this;
        var callback2 = typeof options == "function" ? options : callback2;
        var options = options || {};
        ...
        if (data) {
          if (options.multipart) {
            ...
            return multipart.build(data, boundary, function(err, body) {
              ...
              self.send_request(1, method, uri, config, body, callback2);
            });
          } else {
            var post_data = typeof data === "string" ? data : options.json ? JSON.stringify(data) : stringify(data);
        ...
        return this.send_request(1, method, uri, config, post_data, callback2);
      },
      ...
      send_request: function(count, method, uri, config, post_data, callback2) {
        var timer, self = this, request_opts = this.get_request_opts(method, uri, config), protocol = request_opts.protocol == "https:" ? https : http;
        if (Readable && !config.out) {
          config.out = new Readable();
          config.out.on("error", function(er) {
          });
        }
        ...
        var request = protocol.request(request_opts, function(resp) {
          ...
          if ([301, 302].indexOf(resp.statusCode) != -1 && headers.location) {
            if (count <= config.follow)
              return self.send_request(++count, "GET", url.resolve(uri, headers.location), config, null, callback2);
            else if (config.follow > 0)
              return callback2(new Error("Max redirects reached. Possible loop in: " + headers.location));
          }
          if (resp.statusCode == 401 && headers["www-authenticate"] && config.credentials) {
            if (!config.headers["Authorization"]) {
              ...
              if (auth_header) {
                ...
                return self.send_request(count, method, uri, config, post_data, callback2);
              }
            }
          }
          var chunks = [], length = 0, compressed = /gzip|deflate/.test(headers["content-encoding"]), mime = self.parse_content_type(headers["content-type"]);
          var response_opts = {
          ...
          if (response_opts.text)
            response_opts.decode = config.decode_response;
          ...
          resp.on("end", function() {
            if (config.out) config.out.push(null);
            var pos = 0;
            resp.bytes = length;
            ...
            if (!compressed || typeof unzip == "undefined")
              return self.response_end(response_opts, resp, callback2);
            unzip(resp.body, function(err, buff) {
              if (!err && buff) resp.body = buff;
              self.response_end(response_opts, resp, callback2);
            });
          });
        });
        if (config.timeout > 0) {
        ...
        request.on("error", function(err) {
          ...
          if (timer) clearTimeout(timer);
          if (callback2) callback2(err || new Error("Unknown error when making request."));
        });
      ...
      response_end: function(opts, resp, callback2) {
        ...
        if (opts.parse && parsers[opts.content_type]) {
          ...
          if (opts.decode && opts.charset && !opts.charset.match(/utf-?8$/i))
            resp.body = require_lib().decode(resp.body, opts.charset);
    ...
    exports.head = function(uri, options, callback2) {
      return Needle.request("HEAD", uri, null, options, callback2);
    };
    exports.get = function(uri, options, callback2) {
      return Needle.request("GET", uri, null, options, callback2);
    };
    exports.post = function(uri, data, options, callback2) {
      return Needle.request("POST", uri, data, options, callback2);
    };
    exports.put = function(uri, data, options, callback2) {
      return Needle.request("PUT", uri, data, options, callback2);
    };
    exports.delete = function(uri, data, options, callback2) {
      return Needle.request("DELETE", uri, data, options, callback2);
    };
    exports.request = function(method, uri, data, opts, callback2) {
      return Needle.request(method.toUpperCase(), uri, data, opts, callback2);
    };
  }
});

// node_modules/google-calendar/GoogleCalendar.js
var require_GoogleCalendar = __commonJS({
  "node_modules/google-calendar/GoogleCalendar.js"(exports, module) {
    ...
    function GoogleCalendar(access_token) {
      this.request = function(type, path, params, options, body, callback2) {
        ...
        function responseHandler(error, response, body2) {
          if (error) return callback2(error, body2);
          if (body2.error) return callback2(body2.error, null);
          return callback2(null, body2);
        }
      };
    ...
    Acl.prototype.delete = function(calendarId2, ruleId, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      ruleId = encodeURIComponent(ruleId);
      this.request(
        "DEL",
        "/calendars/" + calendarId2 + "/acl/" + ruleId,
        {},
        {},
        null,
        callback2
    ...
    Acl.prototype.get = function(calendarId2, ruleId, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      ruleId = encodeURIComponent(ruleId);
      this.request(
        "GET",
    ...
    Acl.prototype.insert = function(calendarId2, acl, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      this.request(
        "POST",
        "/calendars/" + calendarId2 + "/acl",
        {},
        {},
        acl,
        callback2
    ...
    Acl.prototype.list = function(calendarId2, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      this.request(
        "GET",
        "/calendars/" + calendarId2 + "/acl",
    ...
    Acl.prototype.update = function(calendarId2, ruleId, acl, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      ruleId = encodeURIComponent(ruleId);
      this.request(
        "PUT",
    ...
    Acl.prototype.patch = function(calendarId2, ruleId, acl, callback2) {
      calendarId2 = encodeURIComponent(calendarId2);
      ruleId = encodeURIComponent(ruleId);
      this.request(
        "PATCH",
    ...
    function CalendarList(request) {
      this.request = request;
    }
    CalendarList.prototype.delete = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("DELETE", "/users/me/calendarList/" + calendarId2, option2, {}, null, callback2);
    };
    CalendarList.prototype.get = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("GET", "/users/me/calendarList/" + calendarId2, option2, {}, null, callback2);
    };
    CalendarList.prototype.insert = function(calendarList, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      this.request("POST", "/users/me/calendarList", option2, {}, calendarList, callback2);
    };
    CalendarList.prototype.list = function(option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      this.request("GET", "/users/me/calendarList", option2, {}, null, callback2);
    };
    CalendarList.prototype.update = function(calendarId2, calendarList, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("PUT", "/users/me/calendarList/" + calendarId2, option2, {}, calendarList, callback2);
    };
    CalendarList.prototype.patch = function(calendarId2, calendarList, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("PATCH", "/users/me/calendarList/" + calendarId2, option2, {}, calendarList, callback2);
    };
    function Calendars(request) {
      this.request = request;
    }
    Calendars.prototype.clear = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("POST", "/calendars/" + calendarId2 + "/clear", option2, {}, null, callback2);
    };
    Calendars.prototype.delete = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("DELETE", "/calendars/" + calendarId2, option2, {}, null, callback2);
    };
    Calendars.prototype.get = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("GET", "/calendars/" + calendarId2, option2, {}, null, callback2);
    };
    Calendars.prototype.insert = function(calendar2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      this.request("POST", "/calendars", option2, {}, calendar2, callback2);
    };
    Calendars.prototype.update = function(calendarId2, calendar2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      calendarId2 = encodeURIComponent(calendarId2);
      this.request("PUT", "/calendars/" + calendarId2, option2, {}, calendar2, callback2);
    };
    ...
    Events.prototype.delete = function(calendarId2, eventId, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "DELETE",
        "/calendars/" + calendarId2 + "/events/" + eventId,
        option2,
        {},
        null,
        callback2
    ...
    Events.prototype.get = function(calendarId2, eventId, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
    ...
    Events.prototype.import = function(calendarId2, event, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "POST",
        "/calendars/" + calendarId2 + "/events/import",
        option2,
        {},
        event,
        callback2
    ...
    Events.prototype.insert = function(calendarId2, event, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
    ...
    Events.prototype.instances = function(calendarId2, eventId, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "GET",
        "/calendars/" + calendarId2 + "/events/" + eventId + "/instances",
        option2,
        {},
        null,
        callback2
    ...
    Events.prototype.list = function(calendarId2, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
    ...
    Events.prototype.move = function(calendarId2, eventId, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "POST",
        "/calendars/" + calendarId2 + "/events/" + eventId + "/move",
        option2,
        {},
        null,
        callback2
    ...
    Events.prototype.quickAdd = function(calendarId2, text, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "POST",
        "/calendars/" + calendarId2 + "/events/quickAdd",
        option2,
        {},
        null,
        callback2
    ...
    Events.prototype.update = function(calendarId2, eventId, update, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
    ...
    Events.prototype.patch = function(calendarId2, eventId, patch, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
    ...
    Events.prototype.watch = function(calendarId2, watch_request, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      ...
      this.request(
        "POST",
        "/calendars/" + calendarId2 + "/events/watch",
        option2,
        {},
        watch_request,
        callback2
    ...
    Events.prototype.stopWatch = function(stop_request, callback2) {
      this.request(
        "POST",
        "/channels/stop",
        {},
    ...
    function Freebusy(request) {
      this.request = request;
    }
    Freebusy.prototype.query = function(query, option2, callback2) {
      if (!callback2) {
        callback2 = option2;
        option2 = {};
      }
      this.request("POST", "/freeBusy/", option2, {}, query, callback2);
    };
    function Settings(request) {
      this.request = request;
    }
    Settings.prototype.list = function(callback2) {
      this.request(
        "GET",
        "/users/me/settings",
        {},
    ...
    Settings.prototype.get = function(setting, callback2) {
...
export default require_GoogleCalendar();
