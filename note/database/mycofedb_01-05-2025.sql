...
--
-- Host: localhost    Database: mycofedb
-- ------------------------------------------------------
...
INSERT INTO `order_detail` VALUES (1,32,NULL,1,2.00,0.00,2.00),(2,33,NULL,1,4.00,0.00,4.00),(8,37,NULL,1,2.00,0.00,2.00),(16,41,16,1,1.50,0.00,1.50),(19,42,16,1,1.50,0.00,1.50),(21,43,16,1,1.50,0.00,1.50),(28,44,16,1,1.50,0.00,1.50),(33,45,16,1,1.50,0.00,1.50),(35,46,16,1,1.50,0.00,1.50),(39,49,16,1,1.25,0.00,1.25),(42,51,16,1,1.25,0.00,1.25),(43,52,16,1,1.25,0.00,1.25),(45,54,16,1,1.25,0.00,1.25),(72,79,19,1,2.00,0.00,2.00),(73,82,19,1,2.00,0.00,2.00),(74,83,19,1,2.00,0.00,2.00),(75,84,19,2,2.00,0.00,4.00),(76,85,14,2,2.00,0.00,4.00),(77,86,16,1,1.25,0.00,1.25),(78,87,12,1,2.00,0.00,2.00),(79,88,12,1,2.00,0.00,2.00),(80,89,12,1,2.00,0.00,2.00);
...
CREATE TABLE `permissions` (
  ...
  `group` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `is_menu` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `route_key` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_details` VALUES (1,1,'Flavor','Mocha'),(2,1,'Packaging','Plastic Cup'),(3,2,'Size','Small'),(4,2,'Intensity','Strong'),(5,3,'Type','Green'),(6,3,'Sweetened','No'),(7,4,'Topping','Boba'),(8,4,'Sweetened','Yes'),(9,5,'Size','Can'),(10,5,'Volume','330ml'),(11,7,'Fruit Type','Orange'),(12,7,'Pulp','With Pulp'),(13,9,'Texture','Soft'),(14,9,'Flavor','Vanilla'),(15,11,'Type','Young'),(16,11,'Packaging','Natural Shell'),(17,13,'Fruit','Mango'),(18,13,'Sweetener','Honey'),(19,15,'Flavor','Sour Cream & Onion'),(20,15,'Packaging','Bag'),(21,18,'Variety','Fuji'),(22,18,'Weight','150g average'),(23,19,'Sugar Level','Medium'),(24,20,'Sugar Level','No Sugar'),(25,21,'Sugar Level','Low'),(26,22,'Sugar Level','High');
...
INSERT INTO `products` VALUES (8,17,'P011','coffee','mondolkiri','coffee',2,1.25,1,'upload_image-1745519263591-417961445','admin','2025-01-27 06:27:48',0.00),(9,13,'P012','tea','mondolkiri','soft_drink',5,2.00,1,'upload_image-1745073557495-797544134','ranh','2025-04-04 05:44:16',0.00),(12,13,'P013','green tea','arabia','hot drink',3,2.00,1,'upload_image-1745073625266-330630551','ranh','2025-04-09 16:37:32',0.00),(14,1,'P014','black_coffee','arabia','coffee',10,2.00,1,'upload_image-1745073636578-81175154','ranh','2025-04-15 15:51:50',0.00),(15,1,'P015','amazon','arabia','coffee',2,2.00,1,'upload_image-1745073658691-453329945','ranh','2025-04-15 17:19:56',0.00),(16,13,'P016','blue tea','green-tea','tea',0,1.25,1,'upload_image-1745073806980-119492351','ranh','2025-04-15 17:20:58',0.00),(19,1,'P017','amz','arabia','test',4,2.00,1,'upload_image-1745077744859-854754053','ranh','2025-04-19 15:49:04',0.00),(20,17,'P020','blue tea','green-tea','tea',1,1.50,1,'upload_image-1745726771482-61453166','dara','2025-04-27 04:06:11',0.00);
...
LOCK TABLES `sugar_level` WRITE;
/*!40000 ALTER TABLE `sugar_level` DISABLE KEYS */;
INSERT INTO `sugar_level` VALUES (5,'Extra Sweet'),(4,'High'),(2,'Low'),(3,'Medium'),(1,'No Sugar');
/*!40000 ALTER TABLE `sugar_level` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,1,'ranh','kealranh@gmail.com','$2b$10$df5aGiBAXhh8jWvcN2iOCO9EU3kqwkoeN2VTdCW11PMgTeA3YTLqa',1,'ranh','2024-12-11 15:32:21'),(36,1,'vireak','vireak@gmail.com','$2b$10$EEZ5LlHIH/nN.7fUCc3/DugYjwGz/fP2YfSPRWpmsY.c9ZvrFp4Yu',1,'ranh','2025-04-26 18:19:27'),(38,2,'nary','nary@gmail.com','$2b$10$W1SCuDMn.q6/7k9.KrT7Eu9330CGGE/BQgIlKR3n/Wv3VSerOJZWq',1,'ranh','2025-04-30 21:18:56'),(39,2,'srey la','sreyla@gmail.com','$2b$10$e0H81Lt5WthYN01UHo4t8unjILvnh.jzvxq0E9K1h8EpriwIKOn6q',1,'vireak','2025-04-30 22:11:51');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'mycofedb'
--
...
-- Dump completed on 2025-05-01 22:12:15
