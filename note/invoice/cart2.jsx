      ...
      <div className={styles.cartList}>
        {state.cart_list.length === 0 ? (
          <Empty
            ...
            description={
              <span style={{ color: "#595959" }}>Cart is empty</span>
            }
          />
        ) : (
      ...
      <div className={styles.cartCheckout}>
        <div style={{ marginBottom: "1rem" }}>
          ...
          <Select
            ...
            onChange={(value) =>
              setObjSummary((prev) => ({ ...prev, customer_id: value }))
            }
            options={customers}
          />
        </div>
        <div style={{ marginBottom: "1rem" }}>
          ...
          <Select
            ...
            onChange={(value) =>
              setObjSummary((prev) => ({ ...prev, payment_method: value }))
            }
            options={[
        ...
        <div style={{ marginBottom: "1rem" }}>
          ...
          <Input.TextArea
            ...
            onChange={(e) =>
              setObjSummary((prev) => ({ ...prev, remark: e.target.value }))
            }
        ...
        <div style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              {objSummary.total_paid < objSummary.total && (
                <span style={{ color: "#ff4d4f", fontSize: "12px" }}>
                  Paid amount ($
                  {(objSummary.total - objSummary.total_paid).toFixed(2)} more
                  needed)
                </span>
              )}
            </div>
          ...
          <InputNumber
            ...
            onChange={(value) =>
              setObjSummary((prev) => ({ ...prev, total_paid: value }))
            }
            formatter={(value) =>
